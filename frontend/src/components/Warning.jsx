...
export default function Warning() {
  return (
    <div className='w-screen flex h-screen items-center justify-center  font-Poppins'>
      <div className='container flex h-64 justify-center mx-auto items-center rounded-xl shadow-xl gap-5 max-w-lg p-10 space-y-8'>
        <img className='w-28' src={pa_warning} />
        <div>
          <h1 className='text-xl font-bold'>Warning</h1>
          <p className='text-slate-500 text-sm '>
            As the rawest musical genre formed, said lyrics may contain language
          ...
          <div className='container flex gap-5 justify-center mt-5'>
            <Link
              to={'main'}
              className='border border-slate-200  rounded-lg p-2 px-5'
            >
              Okay!
            </Link>
            <Link
